...
export default function BudgetResponsePage() {
  ...
  if (submitted) {
    const messages: Record<string, { title: string; desc: string }> = {
      accepted: { title: 'Budget accepted!', desc: 'The Lamba Lab team will be in touch to kick off your project.' },
      countered: { title: 'Counter-proposal sent!', desc: 'The Lamba Lab team will review and get back to you.' },
      call_requested: { title: 'Call requested!', desc: 'The Lamba Lab team will reach out to schedule a call.' },
    }
    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-lg space-y-8">
        ...
        <div className="text-center space-y-2">
          <h1 className="font-bebas text-3xl text-brand-white tracking-wide">LAMBA LAB</h1>
